...
def create_products(db, categories):
    ...
    products_data = [
        # Electronics
        {
            ...
            "description": "High-quality wireless headphones with noise cancelation. Perfect for music lovers and professionals. Battery life up to 30 hours.",
            "price": 299.99,
        ...
        },
        {
            ...
            "description": "Advanced smartwatch with fitness tracking, heart rate monitor, and GPS. Water resistant up to 50m. Compatible with iOS Android.",
            "price": 399.99,
            "category_id": categories["electronics"].id,
        ...
        {
            "name": "Laptop Stand",
            "description": "Ergonomic aluminum laptop stand. Adjustable height and angle. Improves posture and reduce neck strain. Compatible with all laptop sizes.",
            "price": 49.99,
            "category_id": categories["electronics"].id,
        ...
        {
            "name": "USB-C Hub",
            "description": "Multi-port USB-C hub with HDMI, 3.0, and SD card reader. Fast data transfer and 4k video output. Compakt design perfect for travel.",
            "price": 79.99,
            "category_id": categories["electronics"].id,
        ...
        {
            "name": "Running Shoes",
            "description": "Comfortable running shoes with excellent cushioing .Brathable mesh upper and durable rubber sole. Perfect for jogging and gym workouts.",
            "price": 129.99,
        ...
        },
        {
            ...
            "description": "Inspirational book about design principles and creative thinking. Beautiful illustrations and case studies from famous desugners.",
            "price": 39.99,
            "category_id": categories["books"].id,
        ...
        },
        {
            ...
            "description": "Professional cooking techniques and recipes. Step-by-step instruction with beautiful photography. Learn from world-class chefs.",
            "price": 49.99,
            "category_id": categories["books"].id,
        ...
        {
            "name": "Plant Pot Set",
            "description": "Set of 3 ceramic plant pots with drainage holes. Modern design perfect for indoor plants. Icludes saucers to protect furniture.",
            "price": 34.99,
        ...
        },
        {
            ...
            "description": "Set of 2 decorative throe pillows. Soft and comfortable with removable covers. Perfect for sofa or bed decoration.",
            "price": 39.99,
            "category_id": categories["home-garden"].id,
...
def seed_database():
    ...
    # Инициализизуруем БД (создаем таблицы)
    init_db()
